...
def get_dataloader_single_folder(data_dir, imageFolder='Images', maskFolder='Masks', fraction=0.2, batch_size=4):
    ...
    """
    data_transforms = {
        'Train': transforms.Compose([Resize(imageresize=512, maskresize=512), ToTensor(), Normalize()]),
        'Test': transforms.Compose([Resize(imageresize=512, maskresize=512), ToTensor(), Normalize()]),
    }
